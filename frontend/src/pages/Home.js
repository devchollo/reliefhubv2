...
import { Plus, Filter, MapPin, Clock, AlertCircle, Package, Users, Heart } from 'lucide-react';
      ...
      <div className="bg-white border-b px-6 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-600">Help those in need around Cebu</p>
          </div>
          <button
                ...
                return (
                  <div key={request._id} className="border rounded-lg p-4 hover:shadow-md transition">
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <span className={`text-xs px-2 py-1 rounded-full font-medium ${urgencyColors[request.urgency]}`}>
                        {request.urgency}
                      </span>
                    </div>
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium mb-2">Quantity/Details</label>
            <input
              type="text"
